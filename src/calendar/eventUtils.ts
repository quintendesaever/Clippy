...
const TYPE_PATTERNS: { pattern: RegExp; badge: string; titleLabel: string }[] = [
  ...
  { pattern: /\bcomputer\s+practical\b/i, badge: "W", titleLabel: "Werkcollege" },
  { pattern: /\bcomputerpracticum\b/i, badge: "W", titleLabel: "Werkcollege" },
  { pattern: /\btutorial\b/i, badge: "W", titleLabel: "Werkcollege" },
